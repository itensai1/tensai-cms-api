...
public class PublishBotCommand implements BotCommand {
    ...
    public void handle(CreateMessageEvent event, String text) {
        ...
        draftService.publishDraft(event.chatId(), event.messageThreadId());
        message(event.chatId(), event.messageThreadId(), null,
                "this blog has been published successfully");
    }
